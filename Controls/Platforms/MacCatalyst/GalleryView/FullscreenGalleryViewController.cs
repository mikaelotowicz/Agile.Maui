// Platforms/MacCatalyst/GalleryView/FullscreenGalleryViewController.cs
// MacCatalyst uses the same UIKit APIs as iOS — this file mirrors Platforms/iOS/GalleryView/FullscreenGalleryViewController.cs
using CoreGraphics;
using Foundation;
using UIKit;
